...
def test_func_ge():
  ...
  func_ge_res_1 = func_ge(func_continuous['y'], func_continuous['X'], func_continuous['location'], func_continuous['Z'],
                          ...
                          Bsplines=5, norder1=4, model=None, split_type=1, ratio=[3, 1, 1], plot_res=False)
  pred1 = predict_func(func_ge_res_1, func_continuous['y'], 'Continuous', func_continuous['X'], func_continuous['Z'], func_continuous['location'], Bsplines = 5)
  ...
  pred2 = predict_func(func_ge_res_3, func_survival['y'], 'Survival', func_survival['X'], func_survival['Z'], func_survival['location'], Bsplines = 5)
