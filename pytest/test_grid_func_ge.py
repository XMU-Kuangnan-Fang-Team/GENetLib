...
def test_grid_func_ge():
    ...
    nbasis1 = 7
    params1 = 4
    func_continuous = sim_data_func(
        n=1000, m=30, ytype="Continuous", input_type="func", seed=123
    )
    y = func_continuous["y"]
    Z = func_continuous["Z"]
    location = func_continuous["location"]
    X = func_continuous["X"]
    grid_func_ge_res = grid_func_ge(
        y,
        X,
        location,
        Z,
