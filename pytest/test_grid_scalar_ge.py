...
def test_grid_scalar_ge():
    scalar_continuous = sim_data_scalar(
        rho_G=0.75,
        rho_E=0.3,
        dim_G=500,
        dim_E=5,
    ...
    scalar_survival = sim_data_scalar(
        rho_G=0.75,
        rho_E=0.3,
        dim_G=500,
        dim_E=5,
    ...
    grid_scalar_ge_res_1 = grid_scalar_ge(
        scalar_continuous["y"],
        scalar_continuous["G"],
        scalar_continuous["E"],
        ytype="Continuous",
    ...
    grid_scalar_ge_res_3 = grid_scalar_ge(
        scalar_survival["y"],
        scalar_survival["G"],
        scalar_survival["E"],
        ytype="Survival",
