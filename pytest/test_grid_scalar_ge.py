...
def test_func_ge():
  ...
  grid_scalar_ge_res_1 = grid_scalar_ge(data=scalar_continuous[0], ytype='Continuous', dim_G=500, dim_E=5, haveGE=True, 
  ...
  grid_scalar_ge_res_2 = grid_scalar_ge(data=scalar_binary[0], ytype='Binary', dim_G=500, dim_E=5, haveGE=False, 
                                        num_hidden_layers=2, nodes_hidden_layer=[1000,100], 
                                        Learning_Rate2=[0.035,0.045], L2=[0.01], Learning_Rate1=[0.06], L=[0.09], 
                                        Num_Epochs=50, t = 0.01, model = None, split_type = 1, ratio = [7, 2, 1], 
                                        important_feature = False, plot = False, model_reg = None, isfunc = False)
  grid_scalar_ge_res_3 = grid_scalar_ge(data=scalar_survival[0], ytype='Survival', dim_G=500, dim_E=5, haveGE=False, 
                                        num_hidden_layers=2, nodes_hidden_layer=[1000,100], 
                                        Learning_Rate2=[0.035], L2=[0.01], Learning_Rate1=[0.06,0.07], L=[0.09], 
                                        Num_Epochs=50, t = 0.01, model = None, split_type = 1, ratio = [7, 2, 1], 
                                        important_feature = False, plot = False, model_reg = None, isfunc = False)
